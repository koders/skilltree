...
- [ ] [habit] Unchained's weekly news episode — ~45 min at 1.5x {#unchaineds-weekly-news-episode}
- [ ] [habit] One Bankless or Empire episode on a topic I haven't covered yet — ~1 h {#one-bankless-or-empire-episode-on}
- [ ] [habit] Terminal, 10 min twice a week: staking feed (finance.market-intelligence) and regulation feed (finance.regulation) {#terminal-10-min-twice-a-week}
- [ ] [habit] Skim the [@feed@SR Journal](https://www.stakingrewards.com/journal) and [@feed@The Tie Insights](https://www.thetie.io/insights) — ~15 min {#skim-the-sr-journal-and-the}
- [ ] [habit] Pick the biggest reward-rate move on SR that week and explain its cause in two sentences (issuance change, fee spike, staking-ratio shift, or data issue) {#pick-the-biggest-reward-rate-move}
- [ ] [habit] Write a one-page "how staking works on chain X", compare it with SR's asset page, and note the gaps (also feeds SEO/AEO work) {#write-a-one-page-how-staking}
