...
## Rank 1
- [ ] [read] [time-sensitive] EU / MiCA — ~1 h {#eu-mica}
...
- [ ] [do] Terminal regulation feed — ~30 min {#terminal-regulation-feed}
...
## Recall
- What changed for crypto service providers in the EU on July 1, 2026? {#q1}
- How would the CLARITY Act split oversight between the SEC and CFTC? {#q2}
- What does the GENIUS Act regulate, and what does it leave out? {#q3}
