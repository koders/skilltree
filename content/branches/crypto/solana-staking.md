...
## Rank 1
- [ ] [read] [time-sensitive] Kiln — Alpenglow: what it means for stakers and validators — ~45 min {#kiln-alpenglow-what-it-means-for}
...
- [ ] [read] [time-sensitive] The SOL inflation debate — ~1 h {#the-sol-inflation-debate}
...
- [ ] [read] Blockworks Research — SOL value accrual — ~45 min {#blockworks-research-sol-value-accrual}
...
- [ ] [watch] 1–2 Lightspeed episodes on Alpenglow or SOL issuance — ~1 h {#1-2-lightspeed-episodes-on-alpenglow}
  - Resource: [@search@YouTube search](https://www.youtube.com/results?search_query=Lightspeed+podcast+Alpenglow+SOL+inflation)
- [ ] [do] [time-sensitive] Avalanche Helicon check — ~15 min {#avalanche-helicon-check}
...
## Recall
- What would SIMD-0550 do to SOL's nominal staking yield? {#q1}
- Where does a SOL staker's yield come from besides inflation? {#q2}
- What does Alpenglow replace, and why do validators care? {#q3}
